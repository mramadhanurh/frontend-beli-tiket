        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 mb-4">
                    ...
                    <p>
                        Beli Tiket Liburan Wisata Lokal Terpercaya di Madura. Pembelian Aman & Harga Termurah! Pesan Tiket
                        sekarang.
                    </p>
                    <div class="social">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <p>
                        <i class="fa fa-map-marker"></i> Desa Pandian, RT/RW : 003/001, Kecamatan Kota Sumenep, Kabupaten
                        Sumenep, Jawa Timur, 58591
                    </p>
                </div>
            </div>
            <div class="row text-center mt-3 pb-3">
                <div class="col-md-12">
                    <hr>
                    © <strong>Beli Tiket</strong> 2023 • Hak Cipta Dilindungi
                </div>
            </div>
        </div>
    </footer>
